...
public class BookInfoHttpUtil {

    public static void requestNetForPostBookInfo(Handler handler, String str, String way, int page){
        ...
        String body = null;
        try {
            body = "str="+ URLEncoder.encode(str,"utf-8")
                    +"&way="+URLEncoder.encode(way,"utf-8")
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    //1.创建一个URL对象
                    URL url = new URL("http://192.168.214.42:8080/NEDULibrary/BookInfoServlet");
